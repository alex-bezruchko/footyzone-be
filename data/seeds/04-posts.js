    ...
    return knex('posts').insert([
        {
          ...
          body: 'Everton have reppportedly entered the bidding for Bournemouth and England star Callum Wilson. Marco Silva is intent on adding a reliable goalscorer this summer and appears to have centred on Wilson.',
          category_id: 3
        },
        {
          user_id: 1,
        ...
        { user_id: 2, title: "I ain't been droppin' no eaves, sir! Promise!", published: new Date() }, // 5
        
        { user_id: 2, title: "Of course you are, and I'm coming with you!", published: new Date() }, // 6
        ...
        { user_id: 3, title: 'Well, that rules you out, Pip.', published: new Date() }, // 9
        
        { user_id: 4, title: "We've had one yes. What about second breakfast?", published: new Date() }, // 10
        ...
        { user_id: 5, title: 'Is it secret?! Is it safe?!', published: new Date() },
        ...
        { user_id: 5, title: 'When in doubt, follow your nose.', published: new Date() }, // 16
        
        { user_id: 5, title: 'YOU SHALL NOT PASS!', published: new Date() }, // 17
        
        { user_id: 5, title: 'Fly you fools!', published: new Date() }, // 18
